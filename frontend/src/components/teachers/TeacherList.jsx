...
const TeacherList = () => {
    ...
    const [homeroomData, setHomeroomData] = useState({ teacher_id: '', class_id: '', semester: '1' });
    ...
    const handleHomeroomSubmit = async (e) => {
        ...
        try {
            ...
            setHomeroomData({ teacher_id: '', class_id: '', semester: '1' });
            loadAll();
        } catch (err) {
    ...
    return (
        <div className="teacher-list">
            ...
            {/* ===== TABLE 3: HOMEROOM TEACHER ===== */}
            <div style={{ marginBottom: '3rem' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                    <h3 style={{ margin: 0, color: '#1e293b' }}>🏠 Assign Homeroom Teacher</h3>
                    <button onClick={() => setShowHomeroomForm(true)} className="btn-primary">
